...
class ForecastAdapter(private val forecastList: List<ForecastResponseApi.Item0>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (forecast.weather.isNotEmpty()) {
            ...
            holder.binding.dayOfWeekTextView.text = getDayOfWeek(forecast.dtTxt)
